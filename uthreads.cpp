...
#define NEGATIVE_QUANTUM_USECS "quantum_usecs must be positive"
...
//            fprintf(stderr,SYS_ERR,"unable to block or unblock signal");
//            exit(1);
//        }
//    }
//    else{
 ...
 */
void reset_virtual_timer_for_this_process(void){
